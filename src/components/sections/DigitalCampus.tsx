            ...
            <div className="max-w-[1440px] mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            {modules.map((module, i) => (
                                ...
                                >
                                    <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#0369a1] group-hover:bg-[#0369a1] group-hover:text-foreground transition-all duration-300">
                                        <module.icon size={18} />
                                    </div>
                                    <span className="text-sm font-bold text-foreground">{module.title}</span>
                                </motion.div>
                            ))}
                        </div>
                    ...
                    <div className="relative group">
                        ...
                        >
                            <div className="bg-surface rounded-2xl w-full h-full border border-slate-100 flex overflow-hidden">
                                {/* Dashboard Mockup Mini */}
                                <div className="w-16 h-full bg-surface0 flex flex-col items-center py-6 gap-6">
                                    <div className="w-8 h-8 rounded-lg bg-[#0369a1]" />
                                    <div className="w-6 h-6 rounded-md bg-foreground/10" />
                                    <div className="w-6 h-6 rounded-md bg-foreground/10" />
                                    <div className="w-6 h-6 rounded-md bg-foreground/10" />
                                </div>
                                <div className="flex-1 flex flex-col">
                                    <div className="h-12 border-b border-slate-200 px-6 flex items-center justify-between">
                                        <div className="w-24 h-2 bg-surface0 rounded-full" />
                                    ...
                                    <div className="flex-1 p-6 space-y-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="h-20 bg-white rounded-xl border border-slate-50 p-4 space-y-2">
                                                <div className="w-1/2 h-2 bg-surface0 rounded-full" />
                                                <div className="w-3/4 h-3 bg-surface0 rounded-full" />
                                            </div>
                                        </div>
                                        <div className="h-40 bg-white rounded-xl border border-slate-50 p-4">
                                            <div className="w-full h-full bg-surface/50 rounded-lg flex items-end p-2 gap-1">
