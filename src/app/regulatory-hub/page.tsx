            ...
            <Section className="py-12 border-t border-slate-100">
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="space-y-12">
                        <h2 className="text-3xl font-display font-bold text-foreground">Compliance Frameworks</h2>

                        <div className="group border border-slate-200 rounded-2xl p-8 hover:border-brand/40 transition-colors bg-surface">
                            <div className="flex items-start gap-4 mb-4">
                                <Shield className="w-8 h-8 text-brand" />
                                <h3 className="text-xl font-bold text-foreground">Data Sovereignty & GDPR</h3>
                            </div>
                            ...
                            <ul className="space-y-2 text-sm font-medium text-foreground/70">
                                <li className="flex items-center gap-2">• <span className="text-foreground">Right to Erasure</span> protocols active</li>
                                <li className="flex items-center gap-2">• <span className="text-foreground">Data Portability</span> standards met</li>
                            </ul>
                        </div>
                        ...
                        <div className="group border border-slate-200 rounded-2xl p-8 hover:border-brand/40 transition-colors bg-surface">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-foreground">ISO/IEC 27001 Alignment</h3>
                            </div>
                            <p className="text-foreground/70 leading-relaxed mb-6">
                    ...
                    <div className="space-y-12">
                        <h2 className="text-3xl font-display font-bold text-foreground">Legal Documentation</h2>

                        <div className="space-y-6">
                            <div className="flex items-start gap-6 border-b border-slate-100 pb-6">
                                <FileCheck className="w-6 h-6 text-foreground/70 mt-1" />
                                <div>
                                    <h3 className="text-lg font-bold text-foreground mb-2">Terms of Service</h3>
                            ...
                            <div className="flex items-start gap-6 border-b border-slate-100 pb-6">
                                <Globe2 className="w-6 h-6 text-foreground/70 mt-1" />
                                <div>
                                    <h3 className="text-lg font-bold text-foreground mb-2">Regional Compliance</h3>
                                    <p className="text-foreground/70 text-sm leading-relaxed mb-3">
