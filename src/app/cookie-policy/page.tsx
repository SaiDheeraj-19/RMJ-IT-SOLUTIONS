        ...
        <main className="min-h-screen bg-surface">
            ...
            <div className="bg-surface0 text-foreground pt-40 pb-24 px-6 md:px-12 relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <Link href="/" className="inline-flex items-center text-xs font-mono font-bold text-foreground/70 hover:text-brand transition-colors mb-8 uppercase tracking-widest">
            ...
            <Section className="py-24 bg-white">
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-4 space-y-12">
                        <div className="p-8 bg-surface rounded-3xl border border-slate-100 sticky top-24">
                            <Cookie className="w-10 h-10 text-brand mb-6" />
                            <h3 className="text-xl font-bold text-foreground mb-4">Quick Navigation</h3>
                            <div className="space-y-2">
                                <a href="#what-are-cookies" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">What are cookies?</a>
                                <a href="#how-we-use" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">How we use cookies?</a>
                                <a href="#types-of-cookies" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">Types of cookies</a>
                                <a href="#information-collection" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">Information we collect</a>
                                <a href="#blocking-cookies" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">Managing cookies</a>
                                <a href="#policy-changes" className="block p-3 rounded-lg hover:bg-white text-foreground/70 hover:text-brand text-sm font-bold transition-all border border-transparent hover:border-slate-100 hover:shadow-sm">Policy updates</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-8 space-y-16">
                        ...
                        <div id="what-are-cookies" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-10 h-10 rounded-xl bg-surface0 flex items-center justify-center text-foreground/70">
                                    <Info size={20} />
                                </div>
                        ...
                        <div id="types-of-cookies" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-display font-bold text-foreground">What type of cookies do we use?</h2>
                            </div>
                            <div className="bg-surface rounded-2xl p-8 border border-slate-100 space-y-6">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-bold text-foreground mb-2">Analytical/performance cookies.</h4>
                                    ...
                                    <div>
                                        <h4 className="font-bold text-foreground mb-2">Functionality cookies.</h4>
                                        <p className="text-sm text-foreground/70 leading-relaxed">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-foreground mb-2">Targeting cookies.</h4>
                                        <p className="text-sm text-foreground/70 leading-relaxed">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-foreground mb-2">Marketing & Data Management.</h4>
                                        <p className="text-sm text-foreground/70 leading-relaxed">
                        ...
                        <div id="information-collection" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-display font-bold text-foreground">What kind of information do we collect?</h2>
                            </div>
                            <div className="prose prose-slate max-w-none text-foreground/70 leading-relaxed">
                                <p>
                        ...
                        <div id="blocking-cookies" className="scroll-mt-32">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-display font-bold text-foreground">Your permission and blocking cookies</h2>
                            </div>
                            <div className="prose prose-slate max-w-none text-foreground/70 leading-relaxed space-y-4">
                                ...
                                <div className="p-4 bg-amber-50 border border-amber-100 rounded-lg text-surfacember-900 text-sm">
