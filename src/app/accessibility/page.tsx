        ...
        <main className="min-h-screen bg-white">
            ...
            <Section className="py-12 border-t border-slate-100">
                <div className="max-w-4xl space-y-12">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-display font-bold text-foreground">Conformance Status</h2>
                        <p className="text-lg text-foreground/70 leading-relaxed">
                            The Web Content Accessibility Guidelines (WCAG) defines requirements for designers and developers to improve accessibility for people with disabilities. It defines three levels of conformance: Level A, Level AA, and Level AAA.
                        </p>
                        <p className="text-lg text-foreground/70 leading-relaxed">
                            We strive to conform to <span className="font-semibold text-foreground">WCAG 2.1 Level AA</span> standards whenever possible. We regularly review our site to ensure we maintain these standards.
                        </p>
                    </div>

                    <div className="space-y-4">
                        <h2 className="text-2xl font-display font-bold text-foreground">Accessibility Features</h2>
